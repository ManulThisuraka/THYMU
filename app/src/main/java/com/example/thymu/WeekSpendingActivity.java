...
public class WeekSpendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weekSpendingAdapter = new WeekSpendingAdapter(WeekSpendingActivity.this, myFactList);
    ...
    private void readMonthSpendingItems() {
        ...
        Query query = spendingRef.orderByChild("month").equalTo(months.getMonths());
    ...
    private void readWeekSpendingItems() {
        ...
        spendingRef = FirebaseDatabase.getInstance().getReference("spending").child(onlineUserId);
        Query query = spendingRef.orderByChild("week").equalTo(weeks.getWeeks());
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                myFactList.clear();
