...
public class sleeping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ok = findViewById(R.id.btn_sleep);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CharSequence bedTime = btn_bedTime.getText();

                addDatatoFirebase(bedTime);

                Intent intent = new Intent(sleeping.this, myPlan.class);
    ...
    private void addDatatoFirebase(CharSequence bedTime) {
        ...
        Toast.makeText(sleeping.this, "Data added success", Toast.LENGTH_SHORT).show();
    }
